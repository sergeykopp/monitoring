            ...
            <tr>
                <td>
                    <fieldset>
                        ...
                        <input type="text" name="name" size="50" value="{{ old('name') ?? $directorate->name }}" autocomplete="off" />
                    </fieldset>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="hidden" name="id_directorate" value="{{ old('id_directorate') ?? $directorate->id }}" />
                </td>
