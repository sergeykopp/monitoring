        ...
        if(4 == requestInfo.readyState) {
            if(200 == requestInfo.status) {
                ...
                for (var i=0;i<triggers.length;i++){
                    ...
                    if ((0 == triggers[i].hosts[0].status) && ((!triggers[i].dependencies[0]) || ((triggers[i].dependencies[0]) && (triggers[i].dependencies[0].description != 'Недоступен маршрутизатор')))) {
                        if(counter % 2) {
